            ...
            <td align="center" style="padding: 20px 0;">
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #dee2e6; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px 20px 30px; text-align: center;">
                            <img src="{{ asset('img/logopanexpres_color.png') }}" alt="Logo Pan Express" width="200" style="display: block; margin: 0 auto; max-width: 220px; height: auto; border: 0;">
                            <img src="{{ asset('storage/avatarsavatarspromociones/panexpres_navidad.jpg') }}" alt="Pan Express">
                            <hr style="width: 80%; border: 0; border-top: 5px solid #893e08; margin: 20px auto 0 auto; opacity: 1;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px 40px 30px 40px;">
                            <p style="margin-top: 14px;">
                                ¡Deje que el sabor de la navidad llegue directo a su mesa!
                            </p>
                            <p>
                                En esta época de unión, amor y por supuesto ¡Deliciosa comida!  En Pan Exprés queremos ser parte de tus celebraciones llevando un pan de jamón de la mejor calidad directo a tu hogar.
                            </p>
                            <p>
                                Sabemos que no hay nada como un buen pan de jamón, y es por eso que en Pan Exprés nos encargamos de seleccionar los más exquisitos panes de las mejores panaderías de Caracas.
                            </p>
                            <p>
                                Cómo Hacer tu Pedido:
                            </p>
                            <p>
                                Visita nuestro sitio web http://www.panexpres.com: Encuentra nuestra selección de Panes de Jamón.
                            </p>
                            <p>
                                Elige tu pan favorito con solo un click: Revisa las opciones de las mejores panaderías y selecciona la que más te guste.
                            </p>
                            <p>
                                Realiza tu pedido: Haz tu pedido de forma rápida y segura.
                            </p>
                            <p>
                                Disfruta: Recibe tu Pan de Jamón en la puerta de tu casa.
                            </p>
