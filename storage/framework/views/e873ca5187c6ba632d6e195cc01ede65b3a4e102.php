...
} elseif ($_instance->childHasBeenRendered('9Nwcvfn')) {
    $componentId = $_instance->getRenderedChildComponentId('9Nwcvfn');
    $componentTag = $_instance->getRenderedChildComponentTagName('9Nwcvfn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9Nwcvfn');
} else {
    $response = \Livewire\Livewire::mount('layouts.navbar-nuevo', [
                    'comercioId' => 1,
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('9Nwcvfn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('baEdf5c')) {
    $componentId = $_instance->getRenderedChildComponentId('baEdf5c');
    $componentTag = $_instance->getRenderedChildComponentTagName('baEdf5c');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('baEdf5c');
} else {
    $response = \Livewire\Livewire::mount('afiliado.view-details', [
                        'productId' => $productId
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('baEdf5c', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('5LgihjI')) {
    $componentId = $_instance->getRenderedChildComponentId('5LgihjI');
    $componentTag = $_instance->getRenderedChildComponentTagName('5LgihjI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5LgihjI');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('5LgihjI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
