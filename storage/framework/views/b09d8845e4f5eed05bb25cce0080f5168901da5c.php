...
} elseif ($_instance->childHasBeenRendered('l2551031080-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2551031080-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2551031080-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2551031080-0');
} else {
    $response = \Livewire\Livewire::mount('admin.profile.basic-data', ['user_id' => auth()->user()->id ]);
    $html = $response->html();
    $_instance->logRenderedChild('l2551031080-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('l2551031080-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2551031080-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2551031080-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2551031080-1');
} else {
    $response = \Livewire\Livewire::mount('admin.profile.billing-details', ['user_id' => auth()->user()->id ]);
    $html = $response->html();
    $_instance->logRenderedChild('l2551031080-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/typej/Documentos/github/barcoexpres/resources/views/livewire/admin/profile/update-profile.blade.php ENDPATH**/ ?>