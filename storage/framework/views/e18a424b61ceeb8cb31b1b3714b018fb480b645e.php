    ...
    <div class="row">
        ...
        <div class="col-xl-8 d-flex flex-column align-self-start">
            <div class="row">
                ...
                <div class="col-3"><a class="text-white" href="<?php echo e(route('admin.profile.edit')); ?>">Mi Perfil</a></div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="wrapperRedes d-flex justify-content-start navigationMap">
                <a href="<?php echo e($comercio->instagram); ?>" class="icon instagram centrar">
...
<?php /**PATH /home/typej/Documentos/github/barcoexpres/resources/views/livewire/components/navigation-map.blade.php ENDPATH**/ ?>