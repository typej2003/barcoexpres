                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" wire:change="changeRole(<?php echo e($user); ?>, $event.target.value)">
                                                <option value="admincomercio" <?php echo e(($user->rolecomercio === 'admincomercio') ? 'selected' : ''); ?>>Administrador Comercio</option>
                                                <option value="delivery" <?php echo e(($user->rolecomercio === 'delivery') ? 'selected' : ''); ?>>Delivery</option>
                                            </select>
                                        </td>
                                        <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="" wire:model.defer="state.rolecomercio" class="roleS form-control <?php $__errorArgs = ['role'];
...
<?php /**PATH /home/typej/Documentos/github/barcoexpres/resources/views/livewire/afiliado/repuestoexpres/list-users-comercio.blade.php ENDPATH**/ ?>