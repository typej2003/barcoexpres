...
} elseif ($_instance->childHasBeenRendered('lPgLDoJ')) {
    $componentId = $_instance->getRenderedChildComponentId('lPgLDoJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('lPgLDoJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lPgLDoJ');
} else {
    $response = \Livewire\Livewire::mount('layouts.navbar-nuevo', [
                        'comercioId' => 1,
                        ]);
    $html = $response->html();
    $_instance->logRenderedChild('lPgLDoJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('c4bPDom')) {
    $componentId = $_instance->getRenderedChildComponentId('c4bPDom');
    $componentTag = $_instance->getRenderedChildComponentTagName('c4bPDom');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('c4bPDom');
} else {
    $response = \Livewire\Livewire::mount('components.promociones');
    $html = $response->html();
    $_instance->logRenderedChild('c4bPDom', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('58nHN5k')) {
    $componentId = $_instance->getRenderedChildComponentId('58nHN5k');
    $componentTag = $_instance->getRenderedChildComponentTagName('58nHN5k');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('58nHN5k');
} else {
    $response = \Livewire\Livewire::mount('components.marcas-productos');
    $html = $response->html();
    $_instance->logRenderedChild('58nHN5k', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('53dYd7Y')) {
    $componentId = $_instance->getRenderedChildComponentId('53dYd7Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('53dYd7Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('53dYd7Y');
} else {
    $response = \Livewire\Livewire::mount('components.show-products', ['comercioId' => $comercio_id, 'currencyValue' => $currencyValue]);
    $html = $response->html();
    $_instance->logRenderedChild('53dYd7Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('OokfrGu')) {
    $componentId = $_instance->getRenderedChildComponentId('OokfrGu');
    $componentTag = $_instance->getRenderedChildComponentTagName('OokfrGu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OokfrGu');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('OokfrGu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('U1JgOfD')) {
    $componentId = $_instance->getRenderedChildComponentId('U1JgOfD');
    $componentTag = $_instance->getRenderedChildComponentTagName('U1JgOfD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('U1JgOfD');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('U1JgOfD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
