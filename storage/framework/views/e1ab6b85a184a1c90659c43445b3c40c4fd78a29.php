            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="">Comercios</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<?php endif; ?>
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered table-responsive">
                                ...
                                <tbody wire:loading.class="text-muted">
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo e($compras->firstItem() + $index); ?></th>
                                        <td>
                                            <?php echo e($compra->name); ?>

                                        </td>
                                        <td><?php echo e($compra->created_at ?? 'N/A'); ?></td>
                                        <td>
                                            
                                            <a href="" wire:click.prevent="edit(<?php echo e($compra); ?>)">
                                                <i class="fa fa-edit mr-2"></i>
                                            </a>

                                            <a href="" wire:click.prevent="confirmCompraRemoval(<?php echo e($compra->id); ?>)">
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <form autocomplete="off" wire:submit.prevent="<?php echo e($showEditModal ? 'updateCompra' : 'createCompra'); ?>">
...
<?php /**PATH /home/typej/Documentos/github/barcoexpres-1/resources/views/livewire/compra/list-compras.blade.php ENDPATH**/ ?>